...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        analytics_box.setMaximumHeight(156)
        ...
        self.lbl_turtle_state_c.show()
        turtle_box.setMaximumHeight(232)
