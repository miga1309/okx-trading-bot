# ============================================================
# OKX Turtle Bot
# Version: v054_1_cyber_terminal_fullhd_patch
# Date: 2026-03-13
#
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.btn_start_bot.setMinimumHeight(32)
        ...
        self.btn_stop_bot.setMinimumHeight(32)
        ...
        self.btn_reset_test.setMinimumHeight(30)
        ...
        self.btn_clear_bans.setMinimumHeight(30)
        ...
        self.lbl_balance_summary = QLabel("Balance: 0 USDT | Used: 0 USDT | Available: 0 USDT")
        ...
        self.market_tiles = []
        for i in range(6):
            tile = MarketPulseTile(["BTC","ETH","SOL","LINK","ATOM","MINA"][i])
        ...
        self.turtle_glyph.setMinimumSize(92, 92)
        self.turtle_glyph.setMaximumHeight(104)
        turtle_layout.addWidget(self.turtle_glyph, alignment=Qt.AlignmentFlag.AlignHCenter)
        self.lbl_turtle_regime = QLabel("Turtle-индикатор: ожидание кандидата | Entry allowed: NO")
        ...
        self.lbl_turtle_state_a = QLabel("DONCHIAN / REGIME: waiting for breakout")
        self.lbl_turtle_state_a.setProperty("card", "true")
        self.lbl_turtle_state_b = QLabel("TREND / ATR: channel width and ATR will appear here")
        self.lbl_turtle_state_b.setProperty("card", "true")
        self.lbl_turtle_state_c = QLabel("LIQUIDITY: waiting | ATR: — | MODE: AUTO")
        ...
        layout.addLayout(main_row, stretch=10)
        ...
        self.glow_band.setFixedHeight(34)
    ...
    def on_snapshot(self, payload: dict) -> None:
        ...
        if not preferred_watch:
            preferred_watch = [
                ...
                'LINK-USDT-SWAP', 'ATOM-USDT-SWAP', 'MINA-USDT-SWAP'
            ]
        ...
        for inst in preferred_watch:
            ...
            if any(r[0] == inst for r in radar_rows):
                continue
            if inst in blocked or inst in risky_exit:
                reason = 'Liquidity / exit-risk watchlist'
                score = 39.0 if inst in risky_exit else 41.0
                radar_rows.append((inst, 0.0, 0.0, 'FILTERED', score, reason))
            else:
                reason = 'Market scan standby | breakout / liquidity pending'
                radar_rows.append((inst, 0.0, 0.0, 'WATCH', 18.0, reason))
        fallback_watch = ['BTC-USDT-SWAP', 'ETH-USDT-SWAP', 'SOL-USDT-SWAP', 'LINK-USDT-SWAP', 'ATOM-USDT-SWAP', 'MINA-USDT-SWAP']
        for inst in fallback_watch:
            if len(radar_rows) >= 6:
                break
            if any(r[0] == inst for r in radar_rows):
                continue
            if inst in risky_exit:
                radar_rows.append((inst, 0.0, 0.0, 'FILTERED', 39.0, 'Liquidity / exit-risk watchlist'))
            else:
                radar_rows.append((inst, 0.0, 0.0, 'WATCH', 12.0, 'Market scan standby'))
