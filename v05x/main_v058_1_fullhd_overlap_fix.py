# ============================================================
# OKX Turtle Bot
# Version: v058_cyber_terminal_layout_patch
# Date: 2026-03-13
#
# Changelog v058:
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        for w in (self.lbl_balance_summary, self.lbl_session_pnl):
            balance_layout.addWidget(w)
        left_col.addWidget(balance_box, stretch=2)
        ...
        analytics_box.setMaximumHeight(160)
        right_col.addWidget(analytics_box, stretch=1)
        ...
        self.turtle_glyph.setMinimumSize(64, 64)
        self.turtle_glyph.setMaximumSize(72, 72)
        ...
        self.lbl_turtle_regime.setMinimumHeight(32)
        ...
        right_col.addWidget(turtle_box, stretch=1)
