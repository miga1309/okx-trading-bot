...
def build_main_window_ui(window, deps):
    ...
    window.lbl_header_tg_chip = None
    for chip in (
    ...
    window.btn_tg_start = None
    window.btn_tg_stop = None
    ...
    window.lbl_balance_summary = None
    ...
    window.market_scanner_tabs.addTab(window.scanner_ripping_table, "SPIKE_DEAD")
    window.market_scanner_tabs.addTab(window.scanner_good_table, "PASS")
