...
class BotConfig:
    ...
    scanner_chunk_size: int = 1
    scanner_history_days: int = 1
    scanner_rescan_interval_sec: int = 3600
    scanner_refresh_interval_sec: int = 15
    scanner_symbol_pause_sec: float = 0.0
    scanner_deep_checks_enabled: bool = False
    scanner_orderbook_depth: int = 5
    scanner_popup_tf: str = "15m"
    scanner_popup_candles: int = 80
    scanner_recheck_after_sec: int = 86400
    scanner_status_ttl_sec: int = 3900
    scanner_entry_force_refresh: bool = True
    scanner_window_candles: int = 24
    scanner_dead_window_range_pct_max: float = 0.040
    scanner_dead_avg_range_pct_max: float = 0.006
    scanner_dead_parkinson_max: float = 0.006
    scanner_dead_share_min: float = 0.50
    scanner_dead_er_max: float = 0.35
    scanner_dead_bar_range_pct_max: float = 0.004
    scanner_dead_body_ratio_max: float = 0.25
    scanner_micro_body_ratio_max: float = 0.18
    scanner_narrow_range_pct_max: float = 0.0055
    scanner_flat_close_change_pct_max: float = 0.0015
    scanner_flat_mid_change_pct_max: float = 0.0018
    scanner_flat_dead_window_range_pct_max: float = 0.070
    scanner_flat_dead_avg_range_pct_max: float = 0.010
    scanner_flat_dead_er_max: float = 0.55
    scanner_flat_close_share_min: float = 0.72
    scanner_flat_mid_share_min: float = 0.72
    scanner_narrow_range_share_min: float = 0.72
    scanner_micro_body_share_min: float = 0.72
    scanner_hard_flat_dead_window_range_pct_max: float = 0.025
    scanner_hard_flat_dead_avg_range_pct_max: float = 0.0045
    scanner_hard_flat_close_share_min: float = 0.82
    scanner_hard_narrow_range_share_min: float = 0.80
    scanner_hard_micro_body_share_min: float = 0.78
    scanner_hard_flat_run_share_min: float = 0.45
    scanner_spike_dead_window_range_pct_max: float = 0.075
    scanner_spike_dead_avg_range_pct_max: float = 0.011
    scanner_spike_dead_share_min: float = 0.34
    scanner_spike_share_min: float = 0.08
    scanner_spike_multiplier: float = 2.5
    scanner_spike_count_min: float = 1.0
    scanner_spike_flat_close_share_min: float = 0.52
    scanner_spike_narrow_range_share_min: float = 0.50
    scanner_pass_gate_window_range_pct_min: float = 0.022
    scanner_pass_gate_avg_range_pct_min: float = 0.0045
    scanner_pass_gate_flat_close_share_min: float = 0.78
    scanner_pass_gate_narrow_range_share_min: float = 0.72
    scanner_pass_gate_micro_body_share_min: float = 0.72
    scanner_pass_gate_flat_run_share_min: float = 0.40
    scanner_pass_gate_flat_run_window_range_pct_max: float = 0.035
    scanner_saw_chop_min: float = 61.8
    scanner_saw_er_max: float = 0.28
    scanner_saw_flip_share_min: float = 0.55
    scanner_saw_window_range_pct_min: float = 0.030
