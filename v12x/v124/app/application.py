...
from app.watchdog import launch_watchdog, stop_watchdog
...
class BotApplication:
    ...
    def run(self) -> None:
        ...
        os.environ["OKX_TURTLE_RUNTIME_VERSION"] = self.context.settings.app_version
        os.environ["OKX_TURTLE_ENTRY_MODULE"] = self.context.settings.entry_module
        ...
        watchdog_proc = launch_watchdog(app_version=self.context.settings.app_version)
