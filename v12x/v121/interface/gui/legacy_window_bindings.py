...
from remote_control.controller import RemoteControlController
...
class LegacyWindowBindings:
    ...
    def attach(self, window):
        ...
        window.remote_control_controller = RemoteControlController(window=window, context=self.context)
