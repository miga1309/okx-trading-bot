...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self._ui_mode_profiles = {"balanced": {"gui_ms": 1300, "panel_ms": 48, "grid_ms": 28, "spark_ms": 34, "band_ms": 46, "radar_ms": 32, "glyph_ms": 36}}
    ...
    def on_ui_mode_changed(self, *_args) -> None:
        self._apply_ui_mode_to_controls("balanced", log_change=False)
