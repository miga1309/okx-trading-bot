...
# Version: v111
# Date: 2026-03-25
# Changes: release 111 bootstrap; preserves modular app shell while wiring the stop-engine repair release, manual add-unit GUI flow, and cleaned startup wrappers after the 3-stage architecture transition.
