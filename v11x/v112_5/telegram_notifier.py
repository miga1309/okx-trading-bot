...
def run_worker_forever(queue_dir: Optional[str] = None, poll_interval: float = 2.0, max_attempts: int = 10, log_file: Optional[str] = None, pid_file: Optional[str] = None, status_file: Optional[str] = None, offset_file: Optional[str] = None, remote_bridge_dir: Optional[str] = None) -> None:
    load_dotenv()
