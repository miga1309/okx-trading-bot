...
# - Switched runtime/UI version binding to v080 and UI loader to ui_layout_v080
#
...
class TurtleEngine(QObject):
    ...
    def _skip_profitable_turtle20_reentry(self, inst_id: str) -> tuple[bool, str]:
        """
        v080: не разделяем Turtle 20 и Turtle 55 искусственным profitable-skip.
...
class MainWindow(QMainWindow):
    ...
    def reload_ui(self) -> None:
        ...
        try:
            module_name = getattr(self, "_ui_layout_module_name", "ui_layout_v080")
    ...
    def _build_ui(self) -> None:
        self._ui_layout_module_name = "ui_layout_v080"
