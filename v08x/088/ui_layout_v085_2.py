...
def build_main_window_ui(window, deps):
    ...
    right_col.addWidget(risk_box, stretch=3)

    scanner_box = NeonPanel("Market Scanner")
    ...
    window.lbl_scanner_ready = QLabel("READY: 0")
    window.lbl_scanner_pending = QLabel("PENDING: 0")
    window.lbl_scanner_failed = QLabel("FAILED: 0")
    window.lbl_scanner_safe = QLabel("SAFE: 0")
    window.lbl_scanner_caution = QLabel("CAUTION: 0")
    window.lbl_scanner_risky = QLabel("RISKY: 0")
    window.lbl_scanner_blacklist = QLabel("BLACKLIST: 0")
    window.lbl_scanner_exec_watch = QLabel("EXEC WATCH: 0")
    scanner_cards = [
        window.lbl_scanner_total, window.lbl_scanner_ready, window.lbl_scanner_pending,
        window.lbl_scanner_failed, window.lbl_scanner_safe, window.lbl_scanner_caution,
        window.lbl_scanner_risky, window.lbl_scanner_blacklist, window.lbl_scanner_exec_watch,
    ]
    ...
    readable_cards = [
        ...
        window.lbl_scanner_total, window.lbl_scanner_ready, window.lbl_scanner_pending, window.lbl_scanner_failed,
        window.lbl_scanner_safe, window.lbl_scanner_caution, window.lbl_scanner_risky, window.lbl_scanner_blacklist, window.lbl_scanner_exec_watch,
