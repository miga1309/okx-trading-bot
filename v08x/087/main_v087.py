...
class TurtleEngine(QObject):
    ...
    def update_and_maybe_exit_or_pyramid(self, state: PositionState) -> None:
        ...
        early_invalid_reason = self._early_invalid_exit_reason(state, candles, current_price)
        if early_invalid_reason:
            self.close_position(state, current_price, early_invalid_reason, candles=candles)
            return
