...
class BotConfig:
    ...
    scanner_orderbook_snapshots: int = 4
    scanner_orderbook_pause_sec: float = 0.2
    scanner_recheck_after_sec: int = 86400
    scanner_dead_atr_ratio_max: float = 0.004
    scanner_dead_active_ratio_max: float = 0.35
    ...
    scanner_dead_zero_trade_ratio_min: float = 0.30
    scanner_dead_gap_p95_min_sec: float = 45.0
    scanner_dead_spread_bps_min: float = 8.0
    scanner_dead_depth_usdt_max: float = 2500.0
    scanner_saw_adx_max: float = 20.0
    scanner_saw_flip_rate_min: float = 0.50
    scanner_saw_efficiency_max: float = 0.30
    scanner_saw_false_breakout_min: float = 0.50
    scanner_saw_center_reversion_min: float = 0.55
    scanner_saw_autocorr_max: float = -0.05
    scanner_saw_adx_period: int = 14
    scanner_saw_er_window: int = 20
    scanner_ripping_atr_ratio_min: float = 0.006
    scanner_ripping_range_cv_min: float = 1.0
    scanner_ripping_jump_ratio_min: float = 3.0
    scanner_ripping_burst_trade_ratio_min: float = 0.50
    scanner_ripping_trade_size_cv_min: float = 1.25
    scanner_ripping_gap_p95_min_sec: float = 25.0
    scanner_ripping_spread_cv_min: float = 0.50
    scanner_ripping_depth_cv_min: float = 0.80
    scanner_ripping_depth_usdt_max: float = 2500.0
...
class PositionState:
    ...
    active_stop_mode: str = "ATR"
    desired_stop_mode: str = "ATR"
