...
def build_main_window_ui(window, deps):
    ...
    window.lbl_scanner_dead = QLabel("DEAD: 0")
    window.lbl_scanner_saw = QLabel("SAW: 0")
    window.lbl_scanner_ripping = QLabel("RIPPING: 0")
    ...
    def _build_scanner_table():
        ...
        table.setHorizontalHeaderLabels(["Pair", "First seen", "Last seen", "Hits", "Reason", "Verdict", "Recheck", "Comment"])
    ...
    window.market_scanner_tabs.addTab(window.scanner_dead_table, "Dead")
    window.market_scanner_tabs.addTab(window.scanner_saw_table, "Saw")
    window.market_scanner_tabs.addTab(window.scanner_ripping_table, "Ripping")
    window.tabs.addTab(window.market_scanner_tabs, "Market Scanner")
