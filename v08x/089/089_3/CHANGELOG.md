# v089_2 — 2026-03-19
- Поле Verdict убрано из редактирования в таблице Market Scanner.
- Выбор Verdict перенесён в popup Scanner Review и теперь сохраняется кнопкой `Сохранить`.
- Popup Scanner Review теперь также редактирует комментарий и после сохранения обновляет строку таблицы.
