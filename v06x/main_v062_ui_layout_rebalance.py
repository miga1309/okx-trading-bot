# ============================================================
# OKX Turtle Bot
# Version: v062_ui_layout_rebalance
# Date: 2026-03-13
#
# Changelog v062_ui_layout_rebalance:
# - Rebalanced the terminal layout for FullHD work without requiring fullscreen
# - Moved Activity Feed into the lower tabs and gave more height to the Trading Desk
# - Enlarged Equity Pulse, compacted Market Radar, and rebuilt Turtle Signal Center into a readable horizontal block
# - Simplified Balance Hub vertical stacking and removed visible chart-step/points clutter while preserving Reload UI support
#
# Previous changelog:
# Changelog v061_1:
...
class MainWindow(QMainWindow):
    ...
    def reload_ui(self) -> None:
        ...
        try:
            module_name = getattr(self, "_ui_layout_module_name", "ui_layout_v062")
    ...
    def _build_ui(self) -> None:
        self._ui_layout_module_name = "ui_layout_v062"
