...
def build_main_window_ui(window, deps):
    ...
    left_col.addWidget(balance_box, stretch=4)
    ...
    window.balance_chart.setMinimumHeight(320)
    ...
    window.turtle_glyph.setMaximumHeight(88)
    ...
    window.activity_feed.setMinimumHeight(118)
    window.activity_feed.setMaximumHeight(150)
    ...
    main_row.addLayout(center_col, 6)
    main_row.addLayout(right_col, 3)
    layout.addLayout(main_row, stretch=8)



    # Readability guards: ensure cards and long lines are fully visible
    readable_cards = [
    ...
    for card in (window.lbl_balance_hero, window.lbl_balance_used, window.lbl_balance_available, window.lbl_balance_equity, window.lbl_turtle_regime):
