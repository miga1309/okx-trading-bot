# ============================================================
# OKX Turtle Bot
# Version: v062_3_singleline_riskbar
# Date: 2026-03-13
#
# Changelog v062_3_singleline_riskbar:
# - Moved Risk Radar from the left column into the terminal header on the right side
# - Freed vertical space to enlarge Command Deck and Balance Hub without requiring fullscreen
# - Kept Activity Feed in lower tabs and preserved the v062 layout rebalance improvements
# - Updated UI hot-reload module binding to ui_layout_v062_5_singleline_riskbar.py
#
# Previous changelog:
# Changelog v061_1:
