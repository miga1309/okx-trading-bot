# ============================================================
# OKX Turtle Bot
# Version: v069_ui_modes
# Date: 2026-03-14
#
# Changelog v069_ui_modes:
# - Added GUI performance selector with Performance / Balanced / Low modes in Command Deck
# - GUI modes now change only interface refresh/animation cadence without touching trading engine logic
# - Balanced is the default mode; state is preserved across Reload UI rebuilds
#
# Previous changelog:
...
class MainWindow(QMainWindow):
    ...
    def reload_ui(self) -> None:
        ...
        try:
            module_name = getattr(self, "_ui_layout_module_name", "ui_layout_v069")
    ...
    def _build_ui(self) -> None:
        self._ui_layout_module_name = "ui_layout_v069"
