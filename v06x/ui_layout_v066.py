...
def build_main_window_ui(window, deps):
    ...
    header_risk_box.setFixedHeight(72)
    header_risk_box.setMinimumWidth(700)
    ...
    header_risk_layout.setContentsMargins(12, 8, 12, 8)
    ...
    window.lbl_signal_funnel = QLabel("Funnel: scanned 0 | flat 0 | ATR 0 | liq 0 | cand 0")
    window.lbl_signal_funnel.setProperty("card", "true")
    ...
    cards = [
        ...
        window.lbl_signal_funnel,
    ]
    positions = [(0, 0), (0, 1), (1, 0), (1, 1), (2, 0), (2, 1), (3, 0), (3, 1), (4, 0, 1, 2), (5, 0, 1, 2)]
    ...
    readable_cards = [
        ...
        window.lbl_worst, window.lbl_long_short, window.lbl_trade_speed, window.lbl_signal_funnel,
