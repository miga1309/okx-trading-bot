...
def build_main_window_ui(window, deps):
    ...
    header_risk_box.setObjectName("HeaderRiskRadar")
    header_risk_box.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
    header_risk_box.setFixedHeight(54)
    header_risk_box.setMinimumWidth(760)
    header_risk_layout = QHBoxLayout(header_risk_box)
    header_risk_layout.setContentsMargins(14, 4, 14, 4)
    header_risk_layout.setSpacing(10)

    window.lbl_positions = QLabel("POS: 0")
    window.lbl_positions.setProperty("syschip", "true")
    window.lbl_runtime = QLabel("UPTIME: —")
    window.lbl_runtime.setProperty("syschip", "true")
    window.lbl_cycle_duration = QLabel("CYCLE: —")
    window.lbl_cycle_duration.setProperty("syschip", "true")
    window.lbl_blocked_count = QLabel("BLOCKS: 0")
    window.lbl_blocked_count.setProperty("syschip", "true")
    window.lbl_close_pending = QLabel("CLOSE: 0")
    window.lbl_close_pending.setProperty("syschip", "true")
    window.lbl_exec_watch = QLabel("WATCH: 0")
    window.lbl_exec_watch.setProperty("syschip", "true")
    ...
    for _risk_lbl in (
        ...
        _risk_lbl.setMinimumWidth(112)
        _risk_lbl.setMaximumHeight(26)
