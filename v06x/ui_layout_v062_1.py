...
def build_main_window_ui(window, deps):
    ...
    header_risk_box = NeonPanel("Risk Radar")
    header_risk_box.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
    header_risk_box.setMaximumHeight(70)
    header_risk_box.setMinimumWidth(650)
    header_risk_layout = QGridLayout(header_risk_box)
    # flatter radar layout
    header_risk_layout.setContentsMargins(8, 10, 8, 8)
    header_risk_layout.setHorizontalSpacing(6)
    header_risk_layout.setVerticalSpacing(2)
    ...
    header_risk_layout.addWidget(window.lbl_positions, 0, 0)
    header_risk_layout.addWidget(window.lbl_runtime, 0, 1)
    header_risk_layout.addWidget(window.lbl_cycle_duration, 1, 0)
    header_risk_layout.addWidget(window.lbl_blocked_count, 1, 1)
    header_risk_layout.addWidget(window.lbl_close_pending, 2, 0)
    header_risk_layout.addWidget(window.lbl_exec_watch, 2, 1)

    header_layout.addWidget(header_risk_box, 0)
    ...
    balance_layout.setContentsMargins(8, 10, 8, 8)
    ...
    readable_cards = [
        window.lbl_balance_hero, window.lbl_balance_used, window.lbl_balance_available, window.lbl_balance_equity,
