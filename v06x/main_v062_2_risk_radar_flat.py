...
# - Updated UI hot-reload module binding to ui_layout_v062_3.py
#
# Previous changelog:
# Changelog v061_1:
...
class MainWindow(QMainWindow):
    ...
    def reload_ui(self) -> None:
        ...
        try:
            module_name = getattr(self, "_ui_layout_module_name", "ui_layout_v062_3")
    ...
    def _build_ui(self) -> None:
        self._ui_layout_module_name = "ui_layout_v062_3"
