# ============================================================
# OKX Turtle Bot
# Version: v073_informative_trade_popups
# Date: 2026-03-14
#
# Changelog v073_informative_trade_popups:
...
class EntryContextDialog(QDialog):
    def __init__(self, payload: dict, context_file: str, parent=None, live_state: Optional[dict] = None):
        ...
        footer = QLabel(f"Контекст: {self.context_file}")
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        self._ui_layout_module_name = "ui_layout_v073"
    ...
    def show_open_position_context(self, index) -> None:
        try:
            ...
            dlg = EntryContextDialog(payload, context_file, self, live_state=row)
            dlg.exec()
        except Exception as exc:
