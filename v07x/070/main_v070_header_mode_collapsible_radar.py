# ============================================================
# OKX Turtle Bot
# Version: v070_header_mode_collapsible_radar
# Date: 2026-03-14
#
...
class TurtleEngine(QObject):
    ...
    def _tf_entry_profile(self) -> dict:
        ...
        if tf_sec <= 60:  # 1m
            base.update({
                ...
                "liquidity": {
                    "max_spread_pct": 0.55,
                    "min_top_book_usdt": 80.0,
                    "min_side_notional_usdt": 180.0,
                    "min_24h_quote_volume": 150000.0,
                    "max_last_mid_deviation_ratio": 0.0075,
                    "soft_side_ratio": 0.35,
                },
            })
            return base
    ...
    def _confirm_breakout(self, candles: list, atr: float, side: str, level: float) -> tuple[bool, str]:
        ...
        tf_sec = self._timeframe_seconds()
        breakout_buffer_mult = float(getattr(self.cfg, "breakout_buffer_atr", 0.0) or 0.0)
        if tf_sec <= 60:
            breakout_buffer_mult *= 0.60
        elif tf_sec <= 300:
            breakout_buffer_mult *= 0.82
...
class MainWindow(QMainWindow):
    ...
    def reload_ui(self) -> None:
        ...
        try:
            module_name = getattr(self, "_ui_layout_module_name", "ui_layout_v070")
    ...
    def _build_ui(self) -> None:
        self._ui_layout_module_name = "ui_layout_v070"
