...
#
# Changelog:
# - Finalized manual entry mode: safer confirmation popup with explicit action buttons
# - Added graceful stop/close handling so pending manual entry decisions are cancelled safely
# - Cleared pending manual signal state on stop and after confirmation dialog closes
# - Preserved accelerated snapshot refresh from v026_2 and manual mode core from v027
# ============================================================
