...
# Version: v028
# Date: 2026-03-12
# Based on: main_v027_4.py
#
# Changelog:
# - Stabilized branch 027 and promoted it to ready release v028
# - Added persistent entry-context snapshots to JSON for every new position
# - Added GUI popup with saved entry context on double-click of an open position
# - Smoothed balance history recording to avoid duplicate same-second points
# - Cleaned version metadata and preserved manual mode, fast snapshots, and Turtle-style unit cap
# ============================================================
