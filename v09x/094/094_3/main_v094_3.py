...
# Version: v094_3
# Date: 2026-03-21
# Changes: global stop recovery for all live positions; fixed ATR->TURTLE mode switch when exchange stop price already matches target; added forced reconcile/rebuild of exchange stops on desync; rebuilt GOOD scanner view to count trade rows instead of collapsing by pair.
