...
# Version: v095
# Date: 2026-03-21
# Changes: added regular OKX connectivity monitoring with CONNECTED/DEGRADED/DISCONNECTED/RECOVERING states and export logs; blocked new entries during connectivity degradation; added reconcile and stop health recovery after reconnect; improved sync restore of position entry time/age from exchange timestamps.
