...
# Version: v099
# Date: 2026-03-23
# Changes: scanner gate hardened with stale-status refresh and bad-market cooldown, OKX gateway now resolves posSide via account config with client IDs for orders/stops, entry audit expanded, and stop/market quality diagnostics improved for deep analysis.
