...
def build_main_window_ui(window, deps):
    ...
    window.lbl_header_telegram_chip = QLabel("TG: OFF")
    window.lbl_header_telegram_chip.setProperty("chip", "true")
    for chip in (
        ...
        window.lbl_header_telegram_chip,
    ):
    ...
    window.btn_header_tg_start = QPushButton("TG START")
    window.btn_header_tg_start.setObjectName("reloadUIButton")
    window.btn_header_tg_start.setCursor(Qt.CursorShape.PointingHandCursor)
    window.btn_header_tg_start.setMinimumHeight(30)
    window.btn_header_tg_start.clicked.connect(window.start_telegram_notifications)
    header_layout.addWidget(window.btn_header_tg_start, 0, Qt.AlignmentFlag.AlignVCenter)

    window.btn_header_tg_stop = QPushButton("TG STOP")
    window.btn_header_tg_stop.setObjectName("reloadUIButton")
    window.btn_header_tg_stop.setCursor(Qt.CursorShape.PointingHandCursor)
    window.btn_header_tg_stop.setMinimumHeight(30)
    window.btn_header_tg_stop.clicked.connect(window.stop_telegram_notifications)
    header_layout.addWidget(window.btn_header_tg_stop, 0, Qt.AlignmentFlag.AlignVCenter)
