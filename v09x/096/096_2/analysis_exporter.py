...
def build_analysis_export_bundle(ctx: ExportBundleContext, mode: str = 'full', snapshot: Optional[dict] = None, cfg: Optional["BotConfig"] = None) -> Path:
    ...
    if mode == 'hourly':
        ...
        all_dts = []
        for key in ['positions_lifecycle', 'entry_candidates', 'decision_trace', 'execution_log', 'risk_events', 'system_health', 'connectivity_log', 'pyramid_diagnostics', 'reentry_diagnostics', 'breakout_quality', 'stop_engine']:
