...
class BotConfig:
    ...
    scanner_ripping_burst_trade_ratio_min: float = 0.65
    scanner_ripping_trade_size_cv_min: float = 3.0
    ...
    scanner_ripping_depth_usdt_max: float = 2000.0
    ...
    initial_stop_verify_delay_sec: float = 12.0
    initial_stop_verify_attempts: int = 10
    initial_stop_verify_delay_between_attempts_sec: float = 0.4
    stop_cycle_request_delay_sec: float = 0.35
    stop_cycle_position_delay_sec: float = 0.60
...
class PositionState:
    ...
    stop_cycle_last_candle_ts: int = 0
    stop_cycle_last_run_at: float = 0.0
    stop_cycle_last_action: str = ""
