...
# Version: v096_5
# Date: 2026-03-22
# Changes: fixed exchange-stop recovery/verification flow, prevented amend/cancel calls without a valid stop id, softened initial-stop failure handling, corrected pyramid avg price refresh from live position data, and improved runtime export fallbacks.
