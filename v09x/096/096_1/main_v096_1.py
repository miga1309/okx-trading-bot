...
# Version: v096_1
# Date: 2026-03-22
# Changes: fixed GOOD scanner verdict column to show only review verdicts; added runtime state migration from previous version folders and stronger sync restoration of units/base_unit_qty after restart; reworked Equity Curve to render the full saved history and color it green/red by result; increased persisted balance history depth.
