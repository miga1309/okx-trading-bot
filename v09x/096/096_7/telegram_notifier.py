...
class TelegramNotifier:
    def __init__(self, enabled: bool, bot_token: str, chat_id: str, queue_dir: Optional[str] = None):
        ...
        base_dir = Path(queue_dir or os.getenv("TELEGRAM_QUEUE_DIR", "logs/telegram_queue"))
...
class TelegramQueueWorker:
    def __init__(self, bot_token: str, chat_id: str, queue_dir: Optional[str] = None, poll_interval: float = 2.0, max_attempts: int = 10):
        self.bot_token = str(bot_token or "").strip()
        self.chat_id = str(chat_id or "").strip()
        self.queue_dir = Path(queue_dir or os.getenv("TELEGRAM_QUEUE_DIR", "logs/telegram_queue"))
...
def main() -> None:
    ...
    parser.add_argument("--queue-dir", default=os.getenv("TELEGRAM_QUEUE_DIR", "logs/telegram_queue"))
    ...
    parser.add_argument("--log-file", default=os.getenv("TELEGRAM_WORKER_LOG", "logs/telegram_worker.log"))
