...
#
# Changelog:
# - Removed duplicated trade mode selector from the top launch panel
# - Replaced lower trade mode combo with a toggle switch button and synchronized it with runtime config
# - Reworked PnL chart to always render 30 slots starting from zeros and scroll left as new points arrive
# - Preserved manual mode, accelerated snapshots, and Turtle-style unit cap from v027_2
# ============================================================
