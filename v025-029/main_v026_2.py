...
#
# Changelog:
# - Removed the ban-list / table refresh countdown from the GUI
# - Simplified the lower control bar to reduce visual noise
# - Preserved runtime counter and merged balance summary layout
# - Prepared a clean new major-version file according to versioning rules
# ============================================================
