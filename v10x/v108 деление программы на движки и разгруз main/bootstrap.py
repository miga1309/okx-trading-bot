...
# Version: v108
# Date: 2026-03-25
# Changes: introduced bootstrap layer that assembles config, event bus, logging, session control, storage, exchange wrappers, and GUI application on top of legacy v107 runtime.
