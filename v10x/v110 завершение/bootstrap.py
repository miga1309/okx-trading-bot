...
# Version: v110
# Date: 2026-03-25
# Changes: stage 3 modular architecture release; added scanner/trading/analysis service layer, GUI presenter/dialog binding for legacy window, runtime stage 3 bundle registration, and exchange facade passthrough while preserving root .env and telegram_worker.exe expectations.
