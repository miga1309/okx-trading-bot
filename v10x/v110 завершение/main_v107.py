...
APP_VERSION = os.getenv("OKX_TURTLE_RUNTIME_VERSION", "v107")
    ...
    def sync_positions_from_exchange(self) -> None:
        ...
        for inst_id in list(self.position_state):
            if inst_id not in seen:
                ...
                should_finalize = close_pending or protective_pending or missing_count >= 2 or stop_state in {"ERROR", "MISSING"} or health_state in {"STOP_UNVERIFIED", "ERROR"}
                if should_finalize:
