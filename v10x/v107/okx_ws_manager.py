...
class OkxWsManager:
    ...
    def _subscribed_bars(self) -> List[str]:
        ...
        bars = [str(getattr(self.cfg, 'timeframe', '15m') or '15m'), str(getattr(self.cfg, 'scanner_long_tf', '15m') or '15m'), str(getattr(self.cfg, 'scanner_fast_tf', '5m') or '5m'), str(getattr(self.cfg, 'scanner_popup_tf', '15m') or '15m')]
