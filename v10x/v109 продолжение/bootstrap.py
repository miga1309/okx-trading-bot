...
# Version: v109
# Date: 2026-03-25
# Changes: stage 2 modular architecture release; introduced runtime engine bundle for positions, execution, stops, reconcile, balance and health, bound runtime services through bootstrap/app context, and upgraded exchange facade to runtime-aware stage 2 gateway.
