...
class ScannerReviewDialog(QDialog):
    REVIEW_TAGS = ["хороший", "пила", "мертвый", "всплеск", "рваный", "плохой"]
    ...
    def __init__(self, payload: dict, parent=None):
        ...
        filter_label = {'DEAD': 'Мёртвый рынок', 'SAW': 'Пила', 'RIPPING': 'Рваный рынок', 'GOOD': 'Хорошие сделки'}.get(str(self.payload.get('scanner_filter_type') or '').upper(), str(self.payload.get('scanner_filter_type', '—')))
