...
# Version: v101
# Date: 2026-03-23
# Changes: introduced OKX WebSocket manager for public/private channels with health integration and WS-backed snapshots, strengthened popup review persistence for good deals, and expanded gateway/runtime synchronization diagnostics.
