...
from PyQt6.QtCore import QAbstractTableModel, QModelIndex, QObject, QPoint, Qt, QThread, QTimer, pyqtSignal, QEvent, QPointF
from PyQt6.QtGui import QColor, QIcon, QPainter, QPen, QPolygon, QPalette, QBrush, QRadialGradient
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"OKX Turtle Bot {APP_VERSION} — Cyber Quant Terminal")
    ...
    def _build_ui(self) -> None:
        ...
        self.lbl_terminal_title = QLabel("OKX TURTLE BOT v047  —  CYBER QUANT TERMINAL")
        ...
        for i in range(6):
            ...
            radar_layout.addWidget(lbl, i // 2, i % 2)
