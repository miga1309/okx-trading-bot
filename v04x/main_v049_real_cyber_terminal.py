...
class AnimatedGridWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        glow.setColorAt(0.0, QColor(255, 50, 210, int(28 + 14 * pulse)))
        glow.setColorAt(0.35, QColor(65, 130, 255, int(24 + 10 * pulse)))
...
class NeonGlyphWidget(QWidget):
    ...
    def paintEvent(self, event) -> None:
        ...
        grad.setColorAt(0.0, QColor(0, 231, 255, int(55 + pulse * 20)))
        grad.setColorAt(0.45, QColor(23, 96, 255, 98))
        grad.setColorAt(0.8, QColor(255, 67, 214, 40))
        grad.setColorAt(1.0, QColor(255, 67, 214, 0))
        painter.setBrush(QBrush(grad))
        painter.setPen(Qt.PenStyle.NoPen)
        ...
        painter.drawEllipse(center, int(radius * 0.70), int(radius * 0.70))
        painter.setPen(QPen(QColor(255, 67, 214, 150), 2))
        painter.drawEllipse(center, int(radius * 0.50), int(radius * 0.50))
        ...
        for angle in range(0, 360, 45):
            rad = math.radians(angle)
            x1 = math.cos(rad) * radius * 0.18
            y1 = math.sin(rad) * radius * 0.18
            x2 = math.cos(rad) * radius * 0.82
            y2 = math.sin(rad) * radius * 0.82
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"OKX Turtle Bot {APP_VERSION} — Real Cyber Terminal FullHD")
    ...
    def _build_ui(self) -> None:
        ...
        self.lbl_terminal_title = QLabel("OKX TURTLE BOT v049  —  REAL CYBER QUANT TERMINAL")
